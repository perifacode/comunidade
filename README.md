...
|--|--|--|--|
Semana 00 | Dinâmica de reconhecimento de ambiente; apresentação para os participantes; conversa para decidir qual será a tecnologia que vamos estudar juntos; estimular os alunos a colocar em seu LinkedIn que estão participando do Spreading the Code. | Criar uma conta no GitHub. | 4
Semana 01 | Introdução ao terminal; configuração do ambiente de desenvolvimento (instalação do interpretador da linguagem de programação, editor de código e Git). | Subir um repositório de estudos sobre terminal no GitHub. | 4
